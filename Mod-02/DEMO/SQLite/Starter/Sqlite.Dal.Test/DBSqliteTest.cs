...
namespace Sqlite.Dal.Test
{
    ...
    public class DBSqliteTest
    {
        ...
        private TeacherRepository _teacherRepository;  // C:\20487D\Ejercicios\Mod-2\DEMO\SQLite\Database
        private DbContextOptions<SchoolContext> _options =
                new DbContextOptionsBuilder<SchoolContext>()
                    .UseSqlite(@"Data Source = C:\20487D\Ejercicios\Mod-2\DEMO\SQLite\Database\SqliteSchool.db")
                    .Options;
